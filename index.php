            ...
            <div class="container">
                ...
                <div class="container card-pagination text-center">
					...
					the_posts_pagination( array(
						'prev_text'          => ign_get_svg( array( 'icon' => 'angle-left' ) ) . '<span class="screen-reader-text">' . __( 'Previous page', 'news-mag-aqua' ) . '</span>',
						'next_text'          => '<span class="screen-reader-text">' . __( 'Next page', 'news-mag-aqua' ) . '</span>' . ign_get_svg( array( 'icon' => 'angle-right' ) ),
