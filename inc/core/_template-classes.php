 ...
 * @return array
 */
function news_mag_aqua_body_classes( $classes ) {
	...
	if ( is_customize_preview() ) {
		$classes[] = 'news-mag-aqua-customizer';
	}

	// Add class on front page.
	if ( is_front_page() && 'posts' !== get_option( 'show_on_front' ) ) {
		$classes[] = 'news-mag-aqua-front-page';
	}
...
add_filter( 'body_class', 'news_mag_aqua_body_classes' );
