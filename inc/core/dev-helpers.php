 ...
 * @since Ignition 1.0
 */
function news_mag_aqua_javascript_detection() {
...
add_action( 'wp_head', 'news_mag_aqua_javascript_detection', 0 );
add_action( 'admin_head', 'news_mag_aqua_javascript_detection', 0 );
